...
<<<<<<< HEAD
In control systems, a mathematical model of the dynamics of the system is often necessary to guarantee the stabilization of the system. This can be problematic in complicated systems where the dynamics are difficult to model or require information that is not available to the designer. %such as failures that change dynamics.
...
=======
>>>>>>> aa851d5e07139f4d8bce606d171ff70d43cd462b
